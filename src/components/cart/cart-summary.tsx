...
export function CartSummary() {
  ...
  return (
    <div className="border-t border-zinc-200 pt-4 mt-4 space-y-2">
      ...
      <a
        href="/checkout"
        className="block w-full text-center bg-red-600 hover:bg-red-700 text-white font-inter font-semibold text-sm px-6 py-3.5 min-h-[48px] leading-[48px] transition-colors duration-200 cursor-pointer rounded-xl mt-4"
      >
        Finalizar compra
      </a>
      <p className="font-inter text-xs text-zinc-400 text-center mt-2">
