  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-2 text-zinc-700 hover:text-zinc-900 font-inter text-sm transition-colors cursor-pointer"
        aria-expanded={open}
        aria-haspopup="true"
      >
        ...
        <>
          ...
          <div className="absolute right-0 top-full mt-2 w-48 bg-white border border-zinc-200 shadow-lg z-50 rounded-xl overflow-hidden">
            <div className="px-4 py-3 border-b border-zinc-100">
              ...
              <p className="font-inter text-xs text-zinc-500 truncate">{userEmail}</p>
            </div>
            <nav className="py-1">
              <a
