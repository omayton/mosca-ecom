      ...
      <div className="container mx-auto max-w-4xl pointer-events-auto">
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-5 shadow-2xl flex flex-col sm:flex-row items-start sm:items-center gap-4">
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            <button
              onClick={decline}
              className="px-4 py-2 text-sm font-inter text-white/60 hover:text-white border border-white/10 hover:border-white/20 rounded-lg transition-colors cursor-pointer"
            >
              Recusar
            </button>
            <button
              onClick={accept}
              className="px-5 py-2 text-sm font-inter font-semibold text-black bg-white hover:bg-zinc-100 rounded-lg transition-colors cursor-pointer"
            >
              Aceitar cookies
            </button>
          </div>
