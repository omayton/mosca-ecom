  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] flex flex-col">
      ...
      <div className="container mx-auto px-4 py-8 flex-1">
        ...
        <h1 className="font-bold text-2xl text-zinc-900 mb-6">Minha Conta</h1>
          ...
          <nav className="w-full md:w-56 flex-shrink-0">
            <ul className="bg-white border border-zinc-100 rounded-xl overflow-hidden shadow-sm">
              <li>
                <Link
                  href="/minha-conta"
                  className="flex items-center gap-3 px-4 py-3.5 text-sm text-zinc-700 hover:bg-zinc-50 transition-colors cursor-pointer"
                >
