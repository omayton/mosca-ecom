  ...
  return (
    <div className="bg-white border border-zinc-100 rounded-xl p-6 shadow-sm">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="font-semibold text-lg text-zinc-900">Alterar Senha</h2>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 max-w-md">
        <div>
          ...
          <input
            ...
            required
            minLength={6}
            className="w-full px-4 py-3 border border-zinc-200 text-sm text-zinc-900 placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-red-500/20 focus:border-red-500 transition-all rounded-lg"
          />
        </div>
        <div>
        ...
        <button
          type="submit"
          disabled={loading}
          className="bg-red-600 hover:bg-red-700 disabled:opacity-50 text-white font-semibold text-sm px-6 py-3 rounded-lg transition-colors cursor-pointer disabled:cursor-not-allowed"
        >
