      ...
      <div className="container mx-auto px-4 py-8 max-w-3xl">
        ...
        {paymentStatus === "approved" && (
          <div className="bg-green-50 border border-green-200 rounded-xl p-6 mb-6 text-center">
            ...
            <h2 className="font-barlow font-bold text-xl text-green-800">Pagamento aprovado!</h2>
        ...
        {paymentStatus === "pending" && (
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-6 mb-6 text-center">
            ...
            <h2 className="font-barlow font-bold text-xl text-amber-800">Aguardando pagamento</h2>
        ...
        {paymentStatus === "rejected" && (
          <div className="bg-red-50 border border-red-200 rounded-xl p-6 mb-6 text-center">
            ...
            <h2 className="font-barlow font-bold text-xl text-red-800">Pagamento não aprovado</h2>
        ...
        <div className="bg-white border border-zinc-100 rounded-xl p-6 shadow-sm space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="font-barlow font-bold text-xl text-zinc-900">
                Pedido #{order.id}
              </h1>
