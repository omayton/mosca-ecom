    ...
    <div className="min-h-screen bg-[#FAFAFA] flex flex-col">
      ...
      <main className="container mx-auto px-4 py-12 flex-1">
        <div className="max-w-3xl mx-auto">
          <h1 className="font-barlow font-bold text-zinc-900 text-3xl md:text-4xl mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-10">
            <div className="bg-white border border-zinc-100 rounded-xl p-5">
              ...
              <h3 className="font-inter font-semibold text-zinc-900 text-sm mb-1">Pecas Raras</h3>
            ...
            <div className="bg-white border border-zinc-100 rounded-xl p-5">
              ...
              <h3 className="font-inter font-semibold text-zinc-900 text-sm mb-1">Envio Nacional</h3>
            ...
            <div className="bg-white border border-zinc-100 rounded-xl p-5">
              ...
              <h3 className="font-inter font-semibold text-zinc-900 text-sm mb-1">Garantia</h3>
          ...
          <div className="bg-zinc-900 rounded-xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div>
              <p className="font-inter font-semibold text-white text-base">Precisa de uma peca especifica?</p>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white font-inter font-semibold text-sm px-6 py-3 rounded-lg transition-colors cursor-pointer whitespace-nowrap"
            >
